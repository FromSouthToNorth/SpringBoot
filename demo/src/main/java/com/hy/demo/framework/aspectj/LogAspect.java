package com.hy.demo.framework.aspectj;

import com.alibaba.fastjson.JSON;
import com.hy.demo.common.annotation.Log;
import com.hy.demo.common.core.domain.model.LoginUser;
import com.hy.demo.common.enums.BusinessStatus;
import com.hy.demo.common.enums.HttpMethod;
import com.hy.demo.common.utils.ServletUtils;
import com.hy.demo.common.utils.StringUtils;
import com.hy.demo.common.utils.ip.IpUtils;
import com.hy.demo.common.utils.spring.SpringUtils;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.hy.demo.common.annotation.Log)")
    ...
    private void setRequestValue(JoinPoint joinPoint, SysOperLog operLog) throws Exception
    {
        ...
        if (HttpMethod.PUT.toString().equals(requestMethod) || HttpMethod.POST.name().equals(requestMethod))
        {
